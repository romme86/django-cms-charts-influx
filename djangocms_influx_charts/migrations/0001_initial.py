    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('influx_db_data_host_port', models.CharField(max_length=3000, verbose_name='InfluxDB data host and port', blank=True)),
                ('influx_db_data_reset_time', models.IntegerField(default=30, verbose_name='InfluxDB reset time')),
                ('influx_db_data_database', models.CharField(max_length=3000, verbose_name='InfluxDB database name', blank=True)),
                ('influx_db_data_select', models.CharField(max_length=3000, verbose_name='InfluxDB select arguments', blank=True)),
                ('influx_db_data_from', models.CharField(max_length=3000, verbose_name='InfluxDB from arguments', blank=True)),
                ('influx_db_data_where', models.CharField(max_length=3000, verbose_name='InfluxDB where arguments', blank=True)),
                ('influx_db_data_time_span', models.IntegerField(default=15000, verbose_name='InfluxDB time span')),
                ('influx_db_data_time_to_group_by', models.IntegerField(default=30, verbose_name='InfluxDB group by time')),
